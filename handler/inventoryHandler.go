...
func CreateInventory(w http.ResponseWriter, r *http.Request, db *sql.DB) {
	ctx := context.Background()
...
func UpdateInventoryID(w http.ResponseWriter, r *http.Request, p httprouter.Params, db *sql.DB) {
	ctx := context.Background()
...
func DeleteInventoryByID(w http.ResponseWriter, r *http.Request, p httprouter.Params, db *sql.DB) {
	ctx := context.Background()
